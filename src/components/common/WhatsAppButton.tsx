...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#20ba5a] text-white p-3.5 sm:p-4 rounded-full shadow-2xl hover:shadow-emerald-500/30 transition-all duration-300 hover:scale-110 flex items-center group cursor-pointer"
    ...
    >
      ...
      <span className="max-w-0 overflow-hidden group-hover:max-w-xs transition-all duration-500 ease-in-out whitespace-nowrap font-bold text-xs sm:text-sm pl-0 group-hover:pl-2">
        Chat on WhatsApp
      </span>
    </a>
  );
