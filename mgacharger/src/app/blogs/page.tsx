...
export const metadata: Metadata = {
  title: "Blogs & Insights | MGA Charger",
  ...
  if (!featuredBlog) {
    return (
      <div className="bg-secondary-bg min-h-screen pb-20">
        <div className="bg-white border-b border-border py-12 text-center">
          <h1 className="text-3xl font-bold text-primary-text mb-4">Knowledge Center</h1>
          <p className="text-secondary-text">No articles found.</p>
        </div>
      </div>
    );
  }
