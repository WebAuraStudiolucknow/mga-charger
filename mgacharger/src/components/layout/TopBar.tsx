...
export function TopBar() {
  return (
    <div className="bg-accent-dark text-white/90 text-xs py-1.5 hidden lg:block border-b border-white/10">
      <div className="max-w-[1280px] xl:max-w-[1400px] mx-auto px-6 lg:px-8 flex justify-between items-center">
        <div className="flex items-center space-x-4">
          ...
          <span className="text-white/90 font-medium bg-white/10 px-2 py-0.5 rounded text-[11px]">GST: 09AFOPG9627E1Z4</span>
          <span className="opacity-40">|</span>
          <span className="text-white/80 text-[11px]">Est. 2002</span>
          <span className="opacity-40">|</span>
          <div className="flex items-center">
            <Clock className="w-3 h-3 mr-1.5 opacity-80" />
            <span className="text-[11px]">Mon - Sat: 9AM - 6PM</span>
          </div>
        </div>
